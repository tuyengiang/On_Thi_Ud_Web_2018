...
<body>
	...
	<div class="main">
		<h1> Danh sách nhân viên tuyển dụng trước năm 2000 </h1>
			<table>
				<thead>
					<th>Stt</th>
					<th>Mã nhân viên</th>
				...
				<?php 
					endwhile; }	else{
						echo "<h4> Không có nhân viên tuyển dụng trước năm 2000 </h4>";
					}
			...
			<br>
			<center><a href="designnv.php">Về quản lý</a></center>
	</div>
	<div class="bottom">
